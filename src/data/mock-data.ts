...
export const articles: Article[] = [
  {
    id: '78',
    title: '𝐁𝐒𝐂𝐇𝐄 𝐩𝐫𝐨𝐠𝐫𝐚𝐦 𝐚𝐜𝐡𝐢𝐞𝐯𝐞𝐬 𝟏𝟎𝟎% 𝐩𝐚𝐬𝐬 𝐫𝐚𝐭𝐞 𝐢𝐧 𝐌𝐚𝐲 𝟐𝟎𝟐𝟓 𝐥𝐢𝐜𝐞𝐧𝐬𝐮𝐫𝐞 𝐞𝐱𝐚𝐦 Th...',
    content: '𝐁𝐒𝐂𝐇𝐄 𝐩𝐫𝐨𝐠𝐫𝐚𝐦 𝐚𝐜𝐡𝐢𝐞𝐯𝐞𝐬 𝟏𝟎𝟎% 𝐩𝐚𝐬𝐬 𝐫𝐚𝐭𝐞 𝐢𝐧 𝐌𝐚𝐲 𝟐𝟎𝟐𝟓 𝐥𝐢𝐜𝐞𝐧𝐬𝐮𝐫𝐞 𝐞𝐱𝐚𝐦 The Chemical Engineering program at Mindanao State University - Iligan Institute of Technology (MSU-IIT) proudly announced a 100% passing rate in the May 2025 Chemical Engineer Licensure Examination (CHELE). This outstanding achievement significantly exceeded the national average of 75.34%. This examination marked a new milestone as it was the first time the CHELE was administered in a computer-based format, mirroring the setup used for the Metallurgical Engineering Licensure Examination. All seven first-time takers from MSU-IIT successfully passed the exam, securing a perfect 100% passing rate for new examinees. Furthermore, one previous examinee from the university also passed, contributing to a total of eight newly licensed chemical engineers from MSU-IIT. The May 2025 CHELE, held from May 21-23, 2025, saw 602 successful examinees out of 799 who participated from various institutions nationwide. The Professional Regulation Commission (PRC) officially released these results today, May 23, 2025. #TheThuumPublication #AccentuatingCoherenceOneWordAtATime',
    sourceName: 'The Thu\\\'um Publication',
    sourceUrl: 'https://www.facebook.com/thethuumpublication/posts/pfbid0jUoSYHpyLevRjMCufuTmaBVtmhfDbTz1SF1W3h8FEZ9oGW1fxwKphGPTxsXUUvfel',
    publishedDate: '2025-05-23T13:48:00.000Z',
    category: 'coe',
    imageUrl: 'https://scontent-cdg4-3.xx.fbcdn.net/v/t39.30808-6/500200955_122240694224036639_7083131038325597139_n.jpg?stp=dst-jpg_s1080x2048_tt6&_nc_cat=106&ccb=1-7&_nc_sid=e5c1b6&_nc_ohc=h0VOtGEBEdYQ7kNvwFDWWMm&_nc_oc=Adke8EO94ZFcY03hlJ5y-9iZOGZ6_MQIRJdb0qyUjRKvkU7DMKJeqOz3yXtt6I-aM2Y&_nc_zt=23&_nc_ht=scontent-cdg4-3.xx&_nc_gid=EMU4QfBpqw-J5Vih5kG5wQ&oh=00_AfKdCvD8I4cvfHklqWMIJu5c6jc_kcW3eOIEWYvfhudt1Q&oe=6837248F',
    isFeatured: true,
  },
  {
    id: '79',
    ...
    category: 'coe',
    imageUrl: 'https://scontent-cdg4-1.xx.fbcdn.net/v/t39.30808-6/495211496_122238623984036639_5482541472524963253_n.jpg?stp=dst-jpg_s1080x2048_tt6&_nc_cat=105&ccb=1-7&_nc_sid=e5c1b6&_nc_ohc=wKuRVWDyiBsQ7kNvwEGUSRM&_nc_oc=AdmZxzDCeLix713Vv1bdFIP4uPcw67MrK6lUeZdIIlqwae9gyE5Q_3N6hJHEZVYcwSs&_nc_zt=23&_nc_ht=scontent-cdg4-1.xx&_nc_gid=EMU4QfBpqw-J5Vih5kG5wQ&oh=00_AfLz6I4bQmuJs4qfM3G006ZfnKdNO9gmXaaBmnEjg8EJqQ&oe=6837330E',
    isFeatured: true,
  },
  {
    id: '80',
    ...
    category: 'coe',
    imageUrl: 'https://scontent-cdg4-3.xx.fbcdn.net/v/t39.30808-6/495224696_122238429362036639_7817415242155982135_n.jpg?stp=dst-jpg_p180x540_tt6&_nc_cat=106&ccb=1-7&_nc_sid=e5c1b6&_nc_ohc=TqWzccsYaIwQ7kNvwEtUMoG&_nc_oc=Adk4oJDhjbB0dZqRew4thtm9qYW2yMUanY5Z9YOYO7oWiFsNIY747BN79C0cylFMZNA&_nc_zt=23&_nc_ht=scontent-cdg4-3.xx&_nc_gid=EMU4QfBpqw-J5Vih5kG5wQ&oh=00_AfJEuwLvtLBG6J74ZEkOH6FyVEQnEVmUhs5K8zrAgtgZZw&oe=68373D0B',
    isFeatured: true,
  },
  {
    id: '81',
    ...
    category: 'coe',
    imageUrl: 'https://scontent-cdg4-1.xx.fbcdn.net/v/t39.30808-6/495578297_122238343082036639_563144629114724589_n.jpg?stp=dst-jpg_s1080x2048_tt6&_nc_cat=102&ccb=1-7&_nc_sid=e5c1b6&_nc_ohc=_RI3pzwpX7MQ7kNvwHMPCuk&_nc_oc=Adn8tPjqSTQOrKTA_YoYQ-m7wcsQXZaXErjX4XSJqgQJGI61KNrY-PQHpXeVCcDXsKs&_nc_zt=23&_nc_ht=scontent-cdg4-1.xx&_nc_gid=EMU4QfBpqw-J5Vih5kG5wQ&oh=00_AfKfmWM6GpjCkSoPdf8KkXhNtesRYU2iKFdfpipgmcXhZQ&oe=683717AF',
    isFeatured: false,
  },
  {
    id: '82',
    ...
    category: 'coe',
    imageUrl: 'https://scontent-cdg4-2.xx.fbcdn.net/v/t39.30808-6/495963073_122238319964036639_272196108330143582_n.jpg?stp=dst-jpg_s1080x2048_tt6&_nc_cat=101&ccb=1-7&_nc_sid=e5c1b6&_nc_ohc=kdDr8ZqhMtAQ7kNvwGGV9mx&_nc_oc=AdlBmDMc36C--L2t-seqgUiY24eJicnxlo47XJbbwPORZgiMsV9TsqmiObXuuuj6LE4&_nc_zt=23&_nc_ht=scontent-cdg4-2.xx&_nc_gid=EMU4QfBpqw-J5Vih5kG5wQ&oh=00_AfJFeburPs07Zv3pqu5ltY0cWWWAPAO7MdjwhIjbUvm2tQ&oe=68371AE4',
    isFeatured: false,
  },
  {
    id: '83',
    ...
    category: 'coe',
    imageUrl: 'https://scontent-lga3-3.xx.fbcdn.net/v/t39.30808-6/495568977_122238171986036639_7684293086525501470_n.jpg?stp=dst-jpg_s1080x2048_tt6&_nc_cat=106&ccb=1-7&_nc_sid=e5c1b6&_nc_ohc=EgwOl47T2K4Q7kNvwHYx3Dx&_nc_oc=Adm_X-JO-uQmhM9trcNM5p8Tr7ITl5I732hJvj9Y7KMXVvaqLz0LJgvlj9ltRvzLrCI&_nc_zt=23&_nc_ht=scontent-lga3-3.xx&_nc_gid=48eGOBlD4e9paKqXoyiH9A&oh=00_AfJ0pg_CmIf39YWpBMS_Eh2AsgVTTuvc5qe1RJH-IHZarA&oe=68365A18',
    isFeatured: false,
  }
];
